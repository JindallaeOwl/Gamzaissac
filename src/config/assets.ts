export const TextureKeys = {
  ...
  floorSoilBase: 'floor-soil-base',
  floorSoilPebbles: 'floor-soil-pebbles',
  floorSoilRoots: 'floor-soil-roots',
  floorSoilCracks: 'floor-soil-cracks',
  floorSoilDamp: 'floor-soil-damp',
  wallSoilFace: 'wall-soil-face',
  wallSoilSide: 'wall-soil-side',
