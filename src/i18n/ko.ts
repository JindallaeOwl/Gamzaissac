...
export const ko: TranslationTree = {
  ...
  messages: {
    ...
    rootGnarlPhaseTwo: '뿌리 옹이: 뿌리가 뒤틀린다',
    wriggleMassPhaseTwo: '꿈틀대는 덩어리: 새끼를 뱉는다',
    flyQueenPhaseTwo: '파리 여왕: 날갯짓이 거세진다',
    thornTanglePhaseTwo: '가시넝쿨 뭉치: 가시가 돋는다',
    ...
    seedPlotHint: '텃밭 · F로 씨눈 심기 (최대 체력 반 칸)',
    seedPlotPlantedHint: '씨눈을 묻어 두었다 · 다음 층에서 자란다',
    seedPlanted: '씨눈을 묻었다. 다음 층에서 만나자',
    seedPlantAlready: '이미 씨눈을 묻어 두었다',
    seedPlantFinalFloor: '여기서 심으면 거둘 층이 없다',
    seedPlantNoHealth: '더 떼어낼 몸이 없다',
    seedGrown: '씨눈이 자랐다!',
    seedWithered: '싹이 시들었다… 동전 한 닢이 남았다',
    clear: '클리어',
    localeKo: '한국어',
    localeEn: '영어',
