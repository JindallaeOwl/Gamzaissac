...
export const en: TranslationTree = {
  ...
  messages: {
    ...
    rootGnarlPhaseTwo: 'Root Gnarl: The roots twist',
    wriggleMassPhaseTwo: 'Wriggle Mass: It spits its brood',
    flyQueenPhaseTwo: 'Fly Queen: Her wings pick up',
    thornTanglePhaseTwo: 'Thorn Tangle: Thorns bristle',
    ...
    seedPlotHint: 'Seed plot · press F to plant an eye (half a max heart)',
    seedPlotPlantedHint: 'An eye is buried here · it grows on the next floor',
    seedPlanted: 'The eye is buried. See you a floor up',
    seedPlantAlready: 'An eye is already buried here',
    seedPlantFinalFloor: 'Nothing left to harvest above this floor',
    seedPlantNoHealth: 'No more of you left to give',
    seedGrown: 'The eye has grown!',
    seedWithered: 'The sprout withered... one coin left behind',
    clear: 'CLEAR',
    localeKo: 'Korean',
    localeEn: 'English',
